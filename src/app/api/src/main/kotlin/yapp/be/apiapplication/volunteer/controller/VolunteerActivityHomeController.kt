...
import yapp.be.apiapplication.shelter.service.VolunteerActivityHomeApplicationService
...
class VolunteerActivityHomeController(
    private val volunteerActivityHomeApplicationService: VolunteerActivityHomeApplicationService,
) {
    ...
    fun getVolunteerEvents(
        ...
        val resDto = volunteerActivityHomeApplicationService.getVolunteerEventHome(reqDto)
